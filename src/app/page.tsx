...
/**
 * Temporary Day 1 landing page. It exists so the Aurora palette can be approved
 * against something real rather than a list of hex codes.
 * Replaced by the login page on Day 3 (see docs/DELIVERY_PLAN.md §4).
 */
